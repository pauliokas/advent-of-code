...
labeled "[Hot Springs](https://en.wikipedia.org/wiki/Hot%5Fspring)" pointing in a seemingly consistent direction; maybe
...
- `S` is the _starting position_ of the animal; there is a pipe on this tile, but your sketch doesn't show what shape
  the pipe has.
