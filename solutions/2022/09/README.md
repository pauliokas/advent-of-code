...
Due to nebulous reasoning involving [Planck lengths](https://en.wikipedia.org/wiki/Planck%5Funits#Planck%5Flength), you
...
_always be touching_ (diagonally adjacent and even overlapping both count as touching):
...
only visits `_1_` position. However, _be careful_: more types of motion are possible than before, so you might want to
