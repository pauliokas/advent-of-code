...
The tall, vertical chamber is exactly _seven units wide_. Each rock appears so that its left edge is two units away from
...
have stopped (but before the 2023rd rock begins falling). In this example, the tower of rocks will be `_3068_` units
tall.
...
`_1000000000000_` rocks have stopped! Only then will they feel confident enough to proceed through the cave.
